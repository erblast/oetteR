...
testhat('test f_plot_colvector'
  ...
  plot_rgb( col = f_plot_col_vector74() )
  plot_rgb_sum( f_plot_col_vector74() )


  plot_rgb( f_plot_col_vector74( reds = F) )
  plot_rgb( f_plot_col_vector74( greys = F) )
  plot_rgb( f_plot_col_vector74( blues = F) )
  plot_rgb( f_plot_col_vector74( greens = F) )
  plot_rgb( f_plot_col_vector74( faint = F) )
