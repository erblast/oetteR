...
plot(data_scales$exp2, data_scales$resp)
plot(data_scales$exp4, data_scales$resp)
plot(data_scales$exp1, data_scales$resp)
plot(data_scales$exp3, data_scales$resp)
