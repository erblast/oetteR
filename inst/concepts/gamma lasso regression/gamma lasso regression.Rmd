...
# f_plot_obj_2_html(taglist, 'taglist', 'perf_auto_data')
...
wr_predict = function( fit, lambda ){
  
  preds = f_predict_regression_add_predictions( data = new_data
                                               , m = fit
                                               , col_target = 'resp'
                                               , formula = new_formula
                                               , s = lambda)
